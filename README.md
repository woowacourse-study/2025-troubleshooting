...
| 주차 | 발표 주제 및 발표자 |
| :--- | :--- |
| [**1주차** (07.27)](#week-1) | • 21일간의 리딩 실험하기 (👤 밍트)<br>• 모니터링 (👤 투다)<br>• 테스트 환경의 중요성, 결정성 위배 (👤 비타)<br>• 우리팀의 CI/CD (👤 칼리) |
| [**2주차** (08.10)](#week-2) | • 이메일 서버 구축기 (👤 새로이)<br>• 로깅 전략 수정하기 (👤 메이)<br>• OIDC 기반 소셜로그인 연동 (👤 모코)<br>• 쿼리 튜닝으로 218배 빨라진 팬 점유율 API (👤 밍트) |
| [**3주차** (08.24)](#week-3) | • 런칭데이 대비 처리율 제한기 및 로드밸런서 적용기 (👤 투다)<br>• 데이터베이스 운영 / 안정성 (👤 칼리) |
| [**4주차** (09.07)](#week-4) | • 검색 기능 개선 실험하기 (👤 메이)<br>• 우리 팀의 TRACES 도입기 (👤 새로이)<br>• 야구보구에서 경기 결과 추출 최적화 (👤 밍트)<br>• 테이블 스키마 무중단 변경 (👤 모코) |
| [**5주차** (09.21)](#week-5) | • 복구와 안전성을 위한 배포 전략 (👤 비타)<br>• FCM & 알림 도메인 (👤 칼리)<br>• DB 분산락도 락이다 (👤 투다) |
| [**6주차** (10.05)](#week-6) | • 웹 크롤러 성능 및 안정성 개선 (👤 밍트)<br>• 모니터링 이사 (CloudWatch → Grafana) (👤 메이)<br>• 서비스 무중단 테이블 스키마 변경 (👤 모코)<br>• 우리 팀에 어울리는 검색 기능 도입 과정 1 (👤 새로이) |
| [**7주차** (10.19)](#week-7) | • 동시성 제어 (👤 비타)<br>• FCM 대량 알림 최적화 (👤 칼리)<br>• 최종적 일관성 제공하기 (👤 투다) |
| [**8주차** (11.02)](#week-8) | • 데이터 파이프라인 설계하기 (👤 밍트)<br>• k6 부하테스트와 튜닝을 통한 서버 성능 개선 (👤 메이)<br>• 이미지 로딩 최적화 (👤 모코)<br>• 우리 서비스, 동시성 문제 해결 사례 (👤 새로이) |
| [**9주차** (11.16)](#week-9) | • GC의 흐름으로 읽는 배치 처리 효율화 (👤 칼리)<br>• 알림 아키텍쳐 개선기 (👤 투다) |
| [**10주차** (11.27)](#week-10) | • 10만 사용자 수용 가능한 아키텍처 (👤 밍트)<br>• 검색 기능 개선 실험하기 2 (👤 메이)<br>• 우리 서비스 검색기능 도입기 2 (👤 새로이) |
| [**11주차** (12.18)](#week-11) | • MMMQ 1 BlockingQueue 파헤치기 (👤 모코)<br>• DTO Projection과 복합 인덱스로 936K Range Scan 제거 (👤 칼리)<br>• 재시도 DLQ (👤 투다) |
| [**12주차** (01.09)](#week-12) | • 활동 추천 알고리즘 개선하기 (👤 밍트)<br>• 테스트 최적화 이야기 (👤 비타)<br>• 우리 서비스에 맞는 이메일 서버 구축기 (👤 새로이) |
| [**13주차** (01.25)](#week-13) | • MySQL Instant 알고리즘 (👤 메이)<br>• 데드락 풀어내기 (👤 모코)<br>• 동기/비동기 vs 블로킹/논블로킹 (👤 칼리) |
| [**14주차** (02.14)](#week-14) | • Coroutine (👤 비타) |
| [**15주차** (03.07)](#week-15) | • Docker Engine java Test Container (👤 메이)<br>• Spring Batch 톺아보기 (👤 돔푸)<br>• 장애없이 선착순 이벤트 진행하기 (👤 새로이) |
...
<table>
  ...
  <tr>
    <td align="center">
      <a href="https://github.com/woowacourse-study/2025-troubleshooting/blob/main/11_11%EC%A3%BC%EC%B0%A8/%5B%E1%84%87%E1%85%A1%E1%86%AF%E1%84%91%E1%85%AD%E1%84%8C%E1%85%A1%E1%84%85%E1%85%AD%5DMMMQ_1_BlockingQueue_%E1%84%91%E1%85%A1%E1%84%92%E1%85%A6%E1%84%8E%E1%85%B5%E1%84%80%E1%85%B5(%E1%84%86%E1%85%A9%E1%84%8F%E1%85%A9).pdf">[📚 MMMQ 1 BlockingQueue 파헤치기]</a>
    </td>
    <td align="center">
  ...
  <tr>
    <td align="center">
      <a href="https://github.com/woowacourse-study/2025-troubleshooting/blob/main/11_11%EC%A3%BC%EC%B0%A8/%5B%E1%84%87%E1%85%A1%E1%86%AF%E1%84%91%E1%85%AD%E1%84%8C%E1%85%A1%E1%84%85%E1%85%AD%5D%E1%84%8C%E1%85%A2%E1%84%89%E1%85%B5%E1%84%83%E1%85%A9_DLQ.pdf">[📚 재시도 DLQ]</a>
    </td>
    <td>&nbsp;</td>
  </tr>
</table>
